-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CANDIDATE', 'PARTNER');
...
CREATE TABLE "EmailSync" (
    ...
    "status" "EmailSyncStatus" NOT NULL DEFAULT 'ACTIVE',
...
-- CreateIndex
CREATE UNIQUE INDEX "PartnerCompany_userId_key" ON "PartnerCompany"("userId");
...
-- AddForeignKey
ALTER TABLE "Job" ADD CONSTRAINT "Job_partnerCompanyId_fkey" FOREIGN KEY ("partnerCompanyId") REFERENCES "PartnerCompany"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EmailSync" ADD CONSTRAINT "EmailSync_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
